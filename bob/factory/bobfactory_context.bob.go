...
var (
	...
	// Relationship Contexts for otps
	otpWithParentsCascadingCtx = newContextual[bool]("otpWithParentsCascading")
	otpRelUserCtx              = newContextual[bool]("otps.users.otps.otps_user_id_fkey")
	...
	userRelOtpsCtx               = newContextual[bool]("otps.users.otps.otps_user_id_fkey")
