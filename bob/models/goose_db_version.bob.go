...
func buildGooseDBVersionColumns(tableName string) gooseDBVersionColumns {
	...
	return gooseDBVersionColumns{
		...
		VersionID:   psql.Quote(tableName, "version_id"),
		IsApplied:   psql.Quote(tableName, "is_applied"),
		Tstamp:      psql.Quote(tableName, "tstamp"),
	}
}
...
func (gooseDBVersionColumns) AliasedAs(tableName string) gooseDBVersionColumns {
	return buildGooseDBVersionColumns(tableName)
}

func (c gooseDBVersionColumns) Unqualified() gooseDBVersionColumns {
	return buildGooseDBVersionColumns("")
}
...
func (o *GooseDBVersion) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	case bob.QueryTypeMerge:
		ctx, err = GooseDBVersions.AfterMergeHooks.RunHooks(ctx, exec, GooseDBVersionSlice{o})
	}
...
func (o GooseDBVersionSlice) AfterQueryHook(ctx context.Context, exec bob.Executor, queryType bob.QueryType) error {
	...
	case bob.QueryTypeMerge:
		ctx, err = GooseDBVersions.AfterMergeHooks.RunHooks(ctx, exec, o)
	}
...
func (o GooseDBVersionSlice) MergeMod() bob.Mod[*dialect.MergeQuery] {
	return bob.ModFunc[*dialect.MergeQuery](func(q *dialect.MergeQuery) {
		q.AppendHooks(func(ctx context.Context, exec bob.Executor) (context.Context, error) {
			return GooseDBVersions.BeforeMergeHooks.RunHooks(ctx, exec, o)
		})
		...
		q.AppendLoader(bob.LoaderFunc(func(ctx context.Context, exec bob.Executor, retrieved any) error {
			...
			default:
				...
				_, err = GooseDBVersions.AfterMergeHooks.RunHooks(ctx, exec, o)
			}
